...
class DistributionBase(FunctionalTestBase):
    ...
    def test_get_valid_id(self):
        ...
        resp1 = self.testapp.put_json('/distribution', params=self.req_data)
    ...
    def test_put_no_id(self):
        resp = self.testapp.put_json('/distribution', params=self.req_data)
    ...
    def test_put_invalid_id(self):
        obj_id = 0xdeadbeef
        resp = self.testapp.put_json('/distribution/{0}'.format(obj_id),

...
* Enter Wave Heigt by selecting Compute from Wind, Computer from Wind and Fetch, or Known Wave Height. If you select Compute from Wind and Fetch, enter a value for Fetch and select the units from the drop-down menu. If you select Known Wave Height, enter a value for height and select the units.
* Click Save.
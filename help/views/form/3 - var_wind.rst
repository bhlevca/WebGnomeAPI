...
Wind Direction and Speed can be entered either by typing a value in the Speed entry box or by clicking in the wind bull’s-eye. 
...
* To select wind speed and direction using the bull’s-eye, click and drag inside the bull’s-eye to change the length of the arrow to indicate speed and the direction of the arrow to indicate the direction of the wind.

Once Wind Speed uncertainty, Date & Time, Speed, and Wind Direction are entered, click Add Entry. Repeat until your wind series is complete. Entries can also be added at fixed hourly increments, allowing you to ignore Date and Time once the initial values are set. 6 hour increments are set by default.
